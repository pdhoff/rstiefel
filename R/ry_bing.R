...
#' function (y, l) 
#' {
#'     .C("ry_bing", PACKAGE="rstiefel", y = as.double(y), l = as.double(l), n = as.integer(length(y)))$y
#'   }
#' 
#' @export ry_bing
ry_bing <-
function(y,l)
{
  ...
  .C("ry_bingc",PACKAGE="rstiefel",y=as.double(y),l=as.double(l),n=as.integer(length(y)))$y
}
